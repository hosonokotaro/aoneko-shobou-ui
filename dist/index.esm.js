...
`,me=e.span`
  display: inline-flex;
`,Le="M",ye="S",ue=({className:e,buttonCallback:t,anchorCallback:n,text:r,buttonSize:l,buttonColor:a,iconKind:s,iconRotate:d,isAnchor:c,href:p,target:h})=>i(Ne,Object.assign({className:e},{children:[c&&i(Ie,Object.assign({href:p||"",target:h,handleClickEvent:n,$buttonColor:a,$buttonSize:l},{children:[s&&o(xe,{iconKind:s,fillColor:"WHITE",size:l===Le?"XXL":"L",iconRotate:null!=d?d:"DEFAULT",$buttonSize:l}),r&&o(ve,Object.assign({$buttonSize:l},{children:r}))]})),!c&&i(Oe,Object.assign({$buttonColor:a,$buttonSize:l,onClick:t},{children:[s&&o(xe,{iconKind:s,fillColor:"WHITE",size:l===Le?"XXL":"L",iconRotate:null!=d?d:"DEFAULT",$buttonSize:l}),r&&o(ve,Object.assign({$buttonSize:l},{children:r}))]}))]})),Ne=e.div`
  display: inline-flex;
  pointer-events: auto;
`,be=t`
  display: inline-flex;
