declare const _default: import("@storybook/types").ComponentAnnotations<import("@storybook/react").ReactRenderer, import("./Icon").IconProps>;
export default _default;
export declare const Info: import("@storybook/types").AnnotatedStoryFn<import("@storybook/react").ReactRenderer, import("./Icon").IconProps>;
export declare const OpenInNew: import("@storybook/types").AnnotatedStoryFn<import("@storybook/react").ReactRenderer, import("./Icon").IconProps>;
